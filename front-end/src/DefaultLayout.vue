        ...
        <div class="flex h-screen">
            ...
            >
                ...
                <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    ...
                    <hr
                        class="border-t border-gray-300 dark:border-gray-700 my-2"
                    />
                    <div
                    ...
                    >
                        <i
                            class="fa-solid fa-folder text-gray-500 dark:text-gray-300"
                        ></i>
                    ...
                    >
                        <i
                            class="fa-solid fa-users text-gray-500 dark:text-gray-300"
                        ></i>
                        <span>Users</span>
                    </a>
