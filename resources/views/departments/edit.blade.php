    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Department</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Update existing department details</p>
                </div>
            </div>
                ...
                <form action="{{ route('department.update', $department->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm 
                            focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 
                            dark:bg-gray-800 dark:text-gray-100">{{ old('description', $department->description) }}</textarea>
                    </div>
