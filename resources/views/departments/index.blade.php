    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Departments</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Manage asset departments</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-inner">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex space-x-3 text-gray-500 dark:text-gray-300">
                            <a href="{{ route('department.edit', $department->id) }}" class="hover:text-blue-500">
                                <i class="fa-solid fa-pen"></i>
                            </a>

                            <form action="{{ route('department.destroy', $department->id) }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to delete this department?')" class="inline">
                                @csrf
                                @method('DELETE')
