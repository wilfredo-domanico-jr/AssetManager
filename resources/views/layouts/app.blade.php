            ...
            <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('category.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 
                            ...
                            {{ request()->routeIs('category.*') ? 'bg-gray-200 dark:bg-gray-700 font-semibold' : '' }}">
                ...
                <a href="{{ route('department.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 
                            hover:bg-gray-200 dark:hover:bg-gray-700 
                            {{ request()->routeIs('department.*') ? 'bg-gray-200 dark:bg-gray-700 font-semibold' : '' }}">
                ...
                <a href="{{ route('user.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 
                            hover:bg-gray-200 dark:hover:bg-gray-700 
                            {{ request()->routeIs('user.*') ? 'bg-gray-200 dark:bg-gray-700 font-semibold' : '' }}">
                    <i class="fa-solid fa-users text-gray-500 dark:text-gray-300"></i>
                    <span>Users</span>
                </a>

                <a href="{{ route('admin.report-email-setting.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 
                            hover:bg-gray-200 dark:hover:bg-gray-700 
                            {{ request()->routeIs('admin.report-email-setting.*') ? 'bg-gray-200 dark:bg-gray-700 font-semibold' : '' }}">
