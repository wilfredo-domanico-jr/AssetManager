<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Tabs -->
            <div class="flex border-b border-gray-200 dark:border-gray-700 mb-4 rounded-lg overflow-hidden">

                  <!-- Depreciation Tab -->
                <a href="{{ url('/reports') }}"
                    class="flex-1 flex items-center justify-center space-x-2 py-2 font-medium focus:outline-none border-r border-gray-300 dark:border-gray-700
   ...
   {{ request()->is('reports/lifecycle') ? 'bg-white text-gray-800' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-white hover:text-gray-800 transition' }}">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <button
                        type="button"
                        class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg shadow-sm transition-all dark:bg-blue-500 dark:hover:bg-blue-600">
